...
\begin{solution}
	...
	\par From the diagram, we can see that the number of students who can play only the piano is \( 60 - 20 = 40 \),
...
\begin{solution}
	...
	\[
		P(\text{3 heads, 3 tails}) = \binom{6}{3} \paren{\frac{1}{2}}^6 = 20 \times \frac{1}{64} = \frac{20}{64} = \boxed{\frac{5}{16}}
	\]
\end{solution}
% ================================================================================ %
...
\begin{tosubmit}
	...
	\begin{center}
		\includegraphics[width=0.50\textwidth]{images/hw02-dice.png}
	\end{center}
